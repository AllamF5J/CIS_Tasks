 ...
 *
 * This function creates an empty queue by allocating memory for the head structure and the array.
 *
 ...
 *
 * This function destroys the queue and frees allocated memory.
 *
 * @param  my_queue : Pointer to the queue structure
 *
 * @retval Status indicating success or failure
 ...
 *
 * This function gets the current number of elements in the queue.
 *
 * @param  my_queue   : Pointer to the queue structure
 ...
 *
 * This function adds an item to the rear of the queue, if there is space available.
 *
 * @param  my_queue : Pointer to the queue structure
 ...
 *
 * This function removes and returns the item at the front of the queue, if it's not empty.
 *
 * @param  my_queue  : Pointer to the queue structure
 ...
 *
 * This function gets the item at the front of the queue without removing it.
 *
 * @param  my_queue   : Pointer to the queue structure
 ...
 *
 * This function gets the item at the rear of the queue without removing it.
 *
 * @param  my_queue   : Pointer to the queue structure
